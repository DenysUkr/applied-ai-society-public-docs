...
**Truth documents.** The mission's principles, values, strategic priorities, and decision frameworks. Written down, version-controlled, accessible to every human and agent on the team. This is [truth management](/docs/truth-management) in practice. If it is not documented, it is not part of the harness.
