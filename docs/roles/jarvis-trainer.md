...
The trainer's guide for running this session is at [Training the MVJ Workshop](/docs/playbooks/practitioner/training-the-mvj-workshop).
...
1. **Complete the [Minimum Viable Jarvis](/docs/playbooks/practitioner/minimum-viable-jarvis) tutorial yourself.** Use it for at least 2-3 weeks.
2. **Read the [trainer's guide](/docs/playbooks/practitioner/training-the-mvj-workshop).** Understand the format, pacing, and common issues.
...
- [Training the MVJ Workshop](/docs/playbooks/practitioner/training-the-mvj-workshop): Logistics, pacing, and lessons learned
