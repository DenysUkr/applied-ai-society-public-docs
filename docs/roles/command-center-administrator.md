...
The Command Center Administrator maintains and evolves an organization's [sovereign command center](/docs/sovereign-command-centers/principles). They oversee the AI agents, context architecture, access controls, and information flows that power the operation.
...
- Tuning the [question bank](/docs/sovereign-command-centers/question-bank) and proactive intelligence features so the command center stays sharp as the organization evolves
...
- [Sovereign Command Center Principles](/docs/sovereign-command-centers/principles): The foundational framework this role maintains
