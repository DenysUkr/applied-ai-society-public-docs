...
Tim is launching the first Applied AI Society chapter in France, starting with Bordeaux. The goal: show European students that the [applied AI economy](/docs/playbooks/practitioner/applied-ai-economy) is real, accessible, and doesn't require a technical background.
